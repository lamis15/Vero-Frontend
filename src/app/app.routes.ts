...
export const routes: Routes = [
  ...
  { path: 'track', canActivate: [authGuard], loadComponent: () => import('./components/tracker/tracker.component').then(m => m.TrackerComponent) },
  { path: 'map', canActivate: [authGuard], loadComponent: () => import('./components/eco-map/eco-map.component').then(m => m.EcoMapComponent) },
  { path: 'shop', canActivate: [authGuard], loadComponent: () => import('./components/shop/shop.component').then(m => m.ShopComponent) },
  { path: 'events', canActivate: [authGuard], loadComponent: () => import('./components/events/events.component').then(m => m.EventsComponent) },
  { path: 'donate', canActivate: [authGuard], loadComponent: () => import('./components/donate/donate.component').then(m => m.DonateComponent) },
  { path: 'donate/success', canActivate: [authGuard], loadComponent: () => import('./components/donate/donate-success.component').then(m => m.DonateSuccessComponent) },
