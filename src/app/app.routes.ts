...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'users/new',
        loadComponent: () =>
          import('./components/admin/admin-users/admin-user-create.component')
            .then(m => m.AdminUserCreateComponent)
      },
      {
        path: 'users/:id/edit',
        loadComponent: () =>
          import('./components/admin/admin-users/admin-user-edit.component')
            .then(m => m.AdminUserEditComponent)
      },
      {
        path: 'messages',
        loadComponent: () =>
          import('./components/admin/admin-messages/admin-messages.component')
            .then(m => m.AdminMessagesComponent)
      },
      {
        path: 'forum',
        loadComponent: () =>
          import('./components/admin/admin-forum/admin-forum.component')
            .then(m => m.AdminForumComponent)
      },
      {
        path: 'products',
        loadComponent: () =>
          import('./components/admin/admin-products/admin-products.component')
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./components/chatbot/chatbot.component')
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () =>
      import('./components/messagerie/messagerie.component')
  ...
  },
  {
    path: 'community/:id',
    loadComponent: () =>
      import('./components/community/thread/thread.component')
        .then(m => m.ThreadComponent)
  },
  {
    path: 'formations',
    loadComponent: () =>
      import('./components/formations/formations.component')
        .then(m => m.FormationsComponent)
  },
  {
    path: 'formations/:id',
    loadComponent: () =>
      import('./components/formation-detail/formation-detail.component')
        .then(m => m.FormationDetailComponent)
  },
  {
    path: 'formations/:id/checkout',
    loadComponent: () =>
      import('./components/formation-checkout/formation-checkout.component')
        .then(m => m.FormationCheckoutComponent)
  },
  {
  ...
  },
  {
    path: 'petitions',
    loadComponent: () =>
      import('./components/petition/petition')
